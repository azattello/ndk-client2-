        ...
        <div className="main__parcels">
                ...
                <header className="header">
                    ...
                    <ul className="Menu">
                        ...
                        <Link to="/parcels2" className="tabbutton-menu" >
                            <img className="icons-svg" src={location.pathname === '/parcels2' ? box2 : box}  alt="" />
                            <p style={location.pathname === '/parcels2' ? { color: '#1F800C' } : { color: '#808080' } }>Посылки</p>
                        </Link>
